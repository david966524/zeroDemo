...
func (c *userClient) AddUser(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*ResponseMsg, error) {
	out := new(ResponseMsg)
...
type UserServer interface {
	...
	AddUser(context.Context, *UserInfo) (*ResponseMsg, error)
...
func (UnimplementedUserServer) AddUser(context.Context, *UserInfo) (*ResponseMsg, error) {
